  ...
  return (
    <div className='border-t pt-14'>
      ...
      <div>
        {
          cartData.map((item,index)=>{
            const prodcutData = products.find((products)=> products._id === item._id);
            return(
              <div key={index} className='py-4 border-t border-b text-gray-700 grid gird-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_0.5fr_0.5fr] items-center gap-4 '>
                  <div className='flex items-start gap-6'>
                    <img src={prodcutData.image[0]} className='w-16 sm:w-20' alt="" />
                    <div >
                      <p className='text-xs sm:text-lg font-medium '>{prodcutData.name}</p>
                      <div className='flex items-center gap-5 mt-2 '>
                          <p>{currency}{prodcutData.price}</p>
      ...
      <div className='flex justify-end my-20'>
        <div className='w-full sm:w-[450xp]'>
          <CartTotal/>
